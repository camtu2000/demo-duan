                  ...
                  <div className="col-sm-12">
                    <div id="slider-carousel" className="carousel slide" data-ride="carousel">
                      <ol className="carousel-indicators">
                        <li data-target="#slider-carousel" data-slide-to={0} className />
                        <li data-target="#slider-carousel" data-slide-to={1} className />
                        <li data-target="#slider-carousel" data-slide-to={2} className="active" />
                      </ol>
